...
std::array<TileType, 4> get_map_collision_tiles(const Position &position, const HitBoxRadius &hitBoxRadius, const Map<MAP_WIDTH, MAP_HEIGHT, TILE_SIZE> &map, const DebugConfiguration &debugCfg) {
